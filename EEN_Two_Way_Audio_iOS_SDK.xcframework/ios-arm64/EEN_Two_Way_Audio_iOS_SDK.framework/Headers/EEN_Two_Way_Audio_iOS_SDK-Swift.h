...
#ifndef EEN_TWO_WAY_AUDIO_IOS_SDK_SWIFT_H
#define EEN_TWO_WAY_AUDIO_IOS_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EEN_Two_Way_Audio_iOS_SDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC25EEN_Two_Way_Audio_iOS_SDK15SignalingClient")
...
SWIFT_CLASS("_TtC25EEN_Two_Way_Audio_iOS_SDK12WebRTCClient")
...
@interface WebRTCClient (SWIFT_EXTENSION(EEN_Two_Way_Audio_iOS_SDK)) <RTCPeerConnectionDelegate>
...
SWIFT_CLASS("_TtC25EEN_Two_Way_Audio_iOS_SDK12WebRTCSocket")
...
@interface WebRTCSocket (SWIFT_EXTENSION(EEN_Two_Way_Audio_iOS_SDK)) <SRWebSocketDelegate>
